...
const Choix_objet = ({ handleSelectedStep, setFormData, formData }) => {
  ...
  const objets = [
    ...
    {
      nom: "demande de paiment de cotisations",
      index: 2,
      volet: "cotisations",
      filtre: "cotisations",
    },
    ...
    {
      nom: "revoir le montant de cotisations",
      index: 4,
      volet: "cotisations",
      filtre: "cotisations",
    },
    {
      nom: "demande de remboursement de cotisations",
      index: 5,
      volet: "cotisations",
      filtre: "cotisations",
    },
    {
      nom: "relatif à l'assurances invalidité",
      index: 6,
      volet: "prestations",
      filtre: "assurance sociale",
    },
    {
      nom: "relatif aux assurances en natures",
      index: 7,
      volet: "prestations",
      filtre: "assurance sociale",
    },
