...
const Consulter_rec = () => {
  ...
  const filtrer = (e) => {
    ...
    if (val !== "placeholder")
      ...
      copieRecours = copieRecours.filter((item) => item[filterChoisi] === val);
  ...
  const afficherInput = (e) => {
    ...
    if (filter === "Objet") {
      ...
      const inp = (
        <form onSubmit={filtrerDate}>
          <div className="filterInput date">
            <input
              type="number"
              placeholder="Ex : 2024"
              ref={dateRef}
            ...
            />
            <button type="submit" name="date" className="btn btn-primary">
              Rechercher
            </button>
          </div>
        </form>
...
//   //afficher la fentre de detail de recours
//   const [showDetail, setShowDetail] = useState({afficher: false, recours : null});
...
//     let copieRecours = allRecours.slice();
//     if(dateValue !== '')
//       copieRecours = copieRecours.filter((item) => item.date.substring(0, 4) === dateValue);
...
//     const val = e.target.value ;
//     if(val !== "placeholder")   //si le placeholder est choisi on reafichera tous les recours
//       copieRecours = copieRecours.filter((item) => item[filterChoisi] === val);
...
//             <select name={filter} onChange={filtrer} id="sel1">
//               <option value="placeholder" > Filtrer par {filter} </option>
//               <option value="demande annulation de cotisations">Demande annulation de cotisations</option>
//               <option value="demande de paiement de cotisations">Demande de paiement de cotisations</option>
//               <option value="pénalité et/ou majoration de retard">Pénalité et/ou majoration de retard</option>
//               <option value="revoir le montant de cotisation">Revoir le montant de cotisation</option>
//               <option value="demande de validation ou remboursement de cotisations">Demande de validation ou remboursement de cotisations</option>
//               <option value="relatif à l'assurance invalidité">Relatif à l'assurance invalidité</option>
//               <option value="realitf aux assurances en natures">Realitf aux assurances en natures</option>
//               <option value="capital décès">Capital décès</option>
//               <option value="augmentation du pension de retraite">Augmentation du pension de retraite</option>
...
//           <form onSubmit={filtrerDate}>
//             <div className="filterInput date">
//               <input type="number" placeholder="Ex : 2024" ref={dateRef}
//                 onChange={(e) => {
//                   if(e.target.value === '')
...
//                 }}
//               />
//               <button type="submit" name="date" className='btn btn-primary'>Rechercher</button>
//             </div>
//           </form>
//         );
//         setInputDate(inp)
