...
const Home = () => {
  ...
  useEffect(() => {
    ...
    axios.get("http://localhost:4000/getStatistiques") 
      .then(res => {
    ...
    <div className="accueil">
      ...
      <div className="cards">
        <ul className="box-info">
          <li>
            <i className='' ><img src={iconRecours} alt="plainte" style={{width: "40px", height: "40px"}}/></i>
            <span className="text">
              <p>Recours</p>
          ...
          <li>
            <i className='' ><img src={iconEnCours} alt="En cours" style={{width: "40px", height: "40px"}}/></i>
            <span className="text">
          ...
          <li>
            <i className='' ><img src={iconTraite} alt="En cours" style={{width: "40px", height: "40px"}}/></i>
            <span className="text">
              <p>traités</p>
          ...
          <li>
            <i className='' ><img src={iconAnnuler} alt="En cours" style={{width: "40px", height: "40px"}}/></i>
            <span className="text">
              <p>Recours annulés</p>
          ...
          <li>
            <i className='' ><img src={iconDecision} alt="En cours" style={{width: "40px", height: "40px"}}/></i>
            <span className="text">
              <p>Décisions</p>
          ...
          <li>
            <i className='' ><img src={iconAccorde} alt="En cours" style={{width: "40px", height: "40px"}}/></i>
            <span className="text">
          ...
          <li>
            <i className='' ><img src={iconRejeter} alt="En cours" style={{width: "40px", height: "40px"}}/></i>
            <span className="text">
          ...
          <li>
            <i className='' ><img src={iconDeconnecter} alt="En cours" style={{width: "40px", height: "40px"}}/></i>
            <span className="text">
